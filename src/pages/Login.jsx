...
function ScatteredCards() {
    ...
    return (
        <div style={{ position: "relative", width: "100%", height: "100%", minHeight: 420 }}>
            ...
            {/* Card 5 — Leaderboard (bottom-right) */}
...
function FormPanel({ done, setDone }) {
    ...
    if (done) {
        return (
            <div style={{ textAlign: "center", animation: "fadeUp 0.4s ease both" }}>
                ...
                <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2rem", letterSpacing: "0.04em", color: C.ink, marginBottom: "0.4rem" }}>You're in.</h2>
    ...
    return (
        <>
            <div className="f0" style={{ marginBottom: "2rem" }}>
                <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2.6rem", letterSpacing: "0.03em", color: C.ink, lineHeight: 1, marginBottom: "0.35rem" }}>Welcome back</h2>
                <p style={{ fontSize: "0.8rem", color: C.inkMid }}>
                    No account?{" "}
                    <Link to="/signup" style={{ color: C.ink, fontWeight: 600, textDecoration: "none", borderBottom: `1px solid ${C.ink}`, paddingBottom: 1 }}>Sign up free</Link>
                </p>
            </div>

            {serverError && (
                <div style={{ marginBottom: "1rem", padding: "0.6rem 0.8rem", background: "#FEE2E2", border: "1px solid #FECACA", borderRadius: 8, fontSize: "0.78rem", color: "#DC2626" }}>
                    {serverError}
                </div>
            )}

            <div className="f1" style={{ display: "flex", gap: "0.5rem", marginBottom: "1.5rem" }}>
                <OAuthBtn icon={<IconGoogle />} label="Google" onClick={handleGoogleClick} />
                <OAuthBtn icon={<IconGitHub />} label="GitHub" disabled />
            </div>

            <div className="f2" style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.5rem" }}>
            ...
            <form onSubmit={handleSubmit} noValidate>
                <div className="f3" style={{ marginBottom: "0.9rem" }}>
                ...
                <div className="f3" style={{ marginBottom: "0.5rem" }}>
                ...
                <div className="f4" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.5rem" }}>
                    <label style={{ display: "flex", alignItems: "center", gap: "0.45rem", cursor: "pointer", fontSize: "0.75rem", color: C.inkMid }}>
                        <div onClick={() => setRemember(p => !p)}
                            style={{ width: 15, height: 15, borderRadius: 4, border: `1.5px solid ${remember ? C.ink : C.border}`, background: remember ? C.ink : "transparent", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.15s", cursor: "pointer", flexShrink: 0 }}>
                            {remember && <svg width="8" height="8" viewBox="0 0 10 10" fill="none"><path d="M2 5l2.5 2.5L8 3" stroke="#FAFAF8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>}
                        </div>
                        Keep me signed in
                    </label>
                    <a href="/forgot" style={{ fontSize: "0.72rem", color: C.inkMid, textDecoration: "none" }}

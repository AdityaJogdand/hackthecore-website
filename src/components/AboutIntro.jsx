    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-[1400px] grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-16 items-center">
                ...
                >
                    <motion.div animate={{ y: [0, -18, 0] }} transition={{ repeat: Infinity, duration: 8 }} className="absolute left-[5%] top-[12%] w-36 h-36 rounded-full bg-[#F4DD0E]" />
                    <motion.div animate={{ y: [0, 14, 0] }} transition={{ repeat: Infinity, duration: 6 }} className="absolute right-[8%] top-6 w-24 h-24 rounded-full bg-black" />
                    <motion.div animate={{ y: [0, -12, 0] }} transition={{ repeat: Infinity, duration: 7 }} className="absolute right-0 bottom-10 w-40 h-40 rounded-full bg-[#F4DD0E]" />
                    <motion.div animate={{ y: [0, -16, 0] }} transition={{ repeat: Infinity, duration: 5.5 }} className="absolute right-[28%] top-[2%] w-14 h-14 rounded-full bg-[#F4DD0E]" />

                    {/* bottom-left corner circles */}
                    <motion.div animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 6.5 }} className="absolute left-[-2%] bottom-[-2%] w-28 h-28 rounded-full bg-[#F4DD0E]" />
                    <motion.div animate={{ y: [0, 12, 0] }} transition={{ repeat: Infinity, duration: 7.5 }} className="absolute left-[10%] bottom-[-4%] w-12 h-12 rounded-full bg-black" />
                    <motion.div animate={{ y: [0, -8, 0] }} transition={{ repeat: Infinity, duration: 5 }} className="absolute left-[-4%] bottom-[18%] w-10 h-10 rounded-full bg-[#F4DD0E]" />
                    ...
                    <div className="absolute inset-0">
                        ...
                        <motion.figure
                            ...
                            className="absolute left-0 top-6 w-[26%] h-[82%] overflow-hidden rounded-[999px] ring-8 ring-white shadow-[0_30px_70px_rgba(0,0,0,.18)]"
                        >
                        ...
                        <motion.figure
                            ...
                            className="absolute left-1/2 -translate-x-1/2 top-0 w-[38%] h-full overflow-hidden rounded-[999px] ring-8 ring-white shadow-[0_35px_80px_rgba(0,0,0,.22)] z-20"
                        >
                        ...
                        <motion.figure
                            ...
                            className="absolute right-0 bottom-6 w-[26%] h-[82%] overflow-hidden rounded-[999px] ring-8 ring-white shadow-[0_30px_70px_rgba(0,0,0,.18)]"
                        >
